...
const LOI_CHUC = {
    "tọt te": { to: "To: Toasty X", from: "Kz",content: "Chúc Tọt Te năm mới nhiều sức khỏe. Bình an và đạt được những điều mình mong mới trong năm nay! Chúc cho Tọt Te thật nhiều sức khỏe để có thể tiếp tục còn đường mình đã chọn! Mong mọi thứ sẽ nhẹ nhàng với Tọt Te hơn trong năm nay và mong mọi điều tốt đẹp sẽ đến với Tọt Te trong thời gian tới!" },
